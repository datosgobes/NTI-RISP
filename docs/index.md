...
El catálogo de información reutilizable de cada organismo será representado mediante una instancia de la clase [`dcat:Catalog`](http://www.w3.org/ns/dcat#Catalog). 

| Metadato | Descripción | Propiedad | T | C | Rango |
|--------------|-----------------|---------------|-------|-------|-----------|
| Nombre | Breve título o nombre dado al catálogo de datos | [dct:title](http://purl.org/dc/terms/title) | Ob | 1..n | [**rdfs:Literal**](http://www.w3.org/2000/01/rdf-schema#Literal)<br>*Cadena alfanumérica, al menos en español `es`<br>- Se recomienda en varios idiomas.* |
| Descripción | Resumen descriptivo del catálogo de datos | [dct:description](http://purl.org/dc/terms/description) | Ob | 1..n | [**rdfs:Literal**](http://www.w3.org/2000/01/rdf-schema#Literal)<br>*Cadena alfanumérica, al menos en español `es`<br>- Se recomienda en varios idiomas.* |
| Órgano publicador | Entidad que publica el catálogo | [dct:publisher](http://purl.org/dc/terms/publisher) | Ob | 1..1 | [**foaf:Agent**](http://xmlns.com/foaf/0.1/Agent)<br>*URI correspondiente a un organismo público diferenciado por un código alfanumérico único ([taxonomía de organismos](#vocab-publisher)) para cada órgano/unidad/oficina que será extraído del [Directorio Común gestionado por el MINHAP](https://administracionelectronica.gob.es/ctt/dir3) según el esquema siguiente*:<br>`http://datos.gob.es/recurso/sector-publico/org/Organismo/{ID}`  |
| Tamaño del catálogo | Número total de documentos y recursos de información inventariados en el catálogo | [dct:extent](http://purl.org/dc/terms/extent) | R | 0..1 | [**dct:SizeOrDuration**](http://purl.org/dc/terms/SizeOrDuration)<br>*Se recomienda incluir el valor de un número entero y su representación textual equivalente* |
| Identificador | Referencia para identificar el catálogo | [dct:identifier](http://purl.org/dc/terms/identifier) | R | 0..1 | [**xsd:anyURI**](http://www.w3.org/2001/XMLSchema#anyURI)<br>*URI que identifica la descripción actual del catálogo* |
| Fecha de creación | Fecha de publicación inicial del catálogo | [dct:issued](http://purl.org/dc/terms/issued) | Ob | 1..1 | [**rdfs:Literal**](http://www.w3.org/2000/01/rdf-schema#Literal)<br>*Fecha/Hora con formato [ISO-8601](https://www.w3.org/TR/1998/NOTE-datetime-19980827): `YYYY-MM-DDThh:mm:ssTZD`* |
| Fecha de actualización | Fecha en la que se modificó por última vez el catálogo | [dct:modified](http://purl.org/dc/terms/modified) | Ob | 1..1 | [**rdfs:Literal**](http://www.w3.org/2000/01/rdf-schema#Literal)<br>*Fecha/Hora con formato [ISO-8601](https://www.w3.org/TR/1998/NOTE-datetime-19980827): `YYYY-MM-DDThh:mm:ssTZD`* |
| Idioma(s) | Idioma(s) en el(los) que se proporciona la información del catálogo | [dc:language](http://purl.org/dc/elements/1.1/language) | Ob | 1..n | [**dct:LinguisticSystem**](http://purl.org/dc/terms/LinguisticSystem)<br>*Valores normalizados `es`, `ga`, `ca`, `eu`, `en`, `fr`. Se usará una etiqueta por cada propiedad* |
| Cobertura geográfica | Ámbito geográfico cubierto por el catálogo | [dct:spatial](http://purl.org/dc/terms/spatial) | R | 0..n | [**rdfs:Resource**](http://www.w3.org/2000/01/rdf-schema#Resource)<br>*Se aplicará preferentemente lo establecido en el anexo V [Taxonomía de territorios](#vocab-spatial). Un recurso por propiedad* |
| Temáticas | Totalidad de materias incluidas en el catálogo | [dcat:themeTaxonomy](http://www.w3.org/ns/dcat#themeTaxonomy) | Ob | 1..1 | [**skos:ConceptScheme**](http://www.w3.org/2004/02/skos/core#ConceptScheme)<br>*Se aplicará preferentemente la taxonomía definida en el anexo IV [Taxonomía de sectores primarios](#vocab-nti-themes). Su valor fijo es:*<br>`http://datos.gob.es/kos/sector-publico/sector` |
| Página web | Dirección web de acceso al catálogo de datos (acceso para el público) | [foaf:homepage](http://xmlns.com/foaf/0.1/homepage) | Ob | 1..1 | [**foaf:Document**](http://xmlns.com/foaf/0.1/Document)<br>*URI que referencia a la portada del catálogo* |
| Términos de uso | Referencia a los términos de uso generales del catálogo | [dct:license](http://purl.org/dc/terms/license) | Ob | 1..1 | [**dct:LicenseDocument**](http://purl.org/dc/terms/LicenseDocument)<br>*URI que referencia al recurso que describe los términos de uso* |
| Documento(s) y recurso(s) de información | Lista de cada uno de los documentos y recursos de información del catálogo | [dcat:dataset](http://www.w3.org/ns/dcat#dataset) | Ob | 1..n | [**dcat:Dataset**](#Dataset)<br>*Tendrá tantas propiedades como entradas en el catálogo* |
...
| Vigencia del recurso | Fecha de validez de un documento o recurso de información o en la que se estima una modificación o actualización de su contenido. | [dct:valid](http://purl.org/dc/terms/valid) | R | 0..1 | [**rdfs:Literal**](http://www.w3.org/2000/01/rdf-schema#Literal)<br>*Fecha con formato ISO8601: `YYYY-MM-DD`.* |
| Recurso(s) relacionado(s) | Enlaces a recursos relacionados con el documento o recurso de información (información sobre los propios datos, material audiovisual, etc.). | [dct:references](http://purl.org/dc/terms/references) | R | 0..n | [**rdfs:Resource**](http://www.w3.org/2000/01/rdf-schema#Resource)<br>*URI que identifica al recurso relacionado. Se pueden incluir tantas propiedades como referencias se conozcan.* |
| Normativa | Normativa relativa al documento o recurso de información. Es un enlace a un documento legal. | [dct:conformsTo](http://purl.org/dc/terms/conformsTo) | R | 0..n | [**rdfs:Resource**](http://www.w3.org/2000/01/rdf-schema#Resource)<br>*URI que identifica al documento legal relacionado. Se pueden incluir tantas propiedades como documentos normativos se conozcan.* |
| Distribución(es) | Referencia a los recursos que identifican los volcados del documento o recurso de información en sus posibles formatos. | [dcat:distribution](http://www.w3.org/ns/dcat#distribution) | Ob | 1..n | [**dcat:Distribution**](#Distribution)<br>*URI que identifica al recurso que describe una distribución del documento o recurso de información. Puede tener tantas propiedades como distribuciones se conozcan.* |
...
## Distribución - Clase: dcat:Distribution - Obligatorio {#Distribution}
Cada conjunto de datos presente tendrá asociada una o varias distribuciones, que son los accesos a los datos representados en distintos formatos.. Cada una de estas distribuciones se describen como instancias de la clase [`dcat:Distribution`](http://www.w3.org/ns/dcat#Distribution)

| Metadato | Descripción | Propiedad | T | C | Rango |
|--------------|-----------------|---------------|-------|-------|-----------|
| Identificador | URI que identifica a la distribución. | [dct:identifier](http://purl.org/dc/terms/identifier) | R | 0..1 | [**xsd:anyURI**](http://www.w3.org/2001/XMLSchema#anyURI)<br>*URI que identifica la ficha descriptiva de la distribución.* |
| Nombre | Breve título o nombre dado a la distribución. | [dct:title](http://purl.org/dc/terms/title) | R | 0..n | [**rdfs:Literal**](http://www.w3.org/2000/01/rdf-schema#Literal)<br>*Cadena alfanumérica, al menos en español `es`<br>- Se recomienda en varios idiomas.* |
| URL de acceso | URL que permite el acceso al volcado o consulta de los documentos o recursos de información. | [dcat:accessURL](http://www.w3.org/ns/dcat#accessURL) | Ob | 1..1 | [**xsd:anyURI**](http://www.w3.org/2001/XMLSchema#anyURI)<br>*URL con la dirección del documento o servicio que permite la obtención de los datos.* |
| Formato | Formato en que se encuentra representado el documento o recurso de información. | [dcat:mediaType](http://www.w3.org/ns/dcat#mediaType) | Ob | 1..1 | [**dct:MediaTypeOrExtent**](http://purl.org/dc/terms/MediaTypeOrExtent)<br>*Recurso que indica el [tipo MIME](https://www.iana.org/assignments/media-types/media-types.xhtml) del formato de los datos. Únicamente se especificará un formato por distribución.* |
| Tamaño | Tamaño aproximado del documento o recurso de información. | [dcat:byteSize](http://www.w3.org/ns/dcat#byteSize) | R | 0..1 | [**xsd:nonNegativeInteger**](http://www.w3.org/2001/XMLSchema#nonNegativeInteger)<br>*El tamaño será descrito en `bytes`* |
